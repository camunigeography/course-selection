	...
	public function databaseStructure ()
	{
		return "
			...
			CREATE TABLE `settings` (
			  ...
			  `IB_messageHtml` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Extra introductory message',
			  ...
			  `II_messageHtml` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Extra introductory message',
